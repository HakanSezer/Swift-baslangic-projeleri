...
class Savasci: UzayGemisi {
    ...
    func ates() {
        kalanAtesGucu -= 1
        print("Kalan cephane: \(kalanAtesGucu)")
        if kalanAtesGucu <= 0 {
...
var yikici = Savasci()
yikici.silah = "lazer"
yikici.kalanAtesGucu = 2
print(yikici.silah, yikici.kalanAtesGucu)
 ...
 */
print("Kartal değişkeni bir önceki sayfada kaldığı için tanımlanmıyor.")
