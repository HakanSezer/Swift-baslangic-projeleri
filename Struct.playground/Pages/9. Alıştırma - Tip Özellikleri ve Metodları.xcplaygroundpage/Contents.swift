...
struct Kullanici {
    ...
    var eposta: String
    var yas: Int
    static var simdikiKullanici: String = "Baterist"
    
    func girisYap(kullanici: Kullanici) {
        print("Hoş Geldimiz!")
        
    }
    
}
Kullanici.simdikiKullanici
/*:
 ...
 */
Kullanici.init(kullaniciAdi: "Nicovrobi", eposta: "hakan@gmail.com", yas: 23)
